...
void lower_impl(const vector<Function> &output_funcs,
    ...
    debug(1) << "Validating GPU async (warp-specialized) producers...\n";
    validate_gpu_async_producers(env, t);
    ...
    if (t.has_gpu_feature()) {
        ...
        s = lower_gpu_warp_async(s, env, t);
    ...
    if (t.has_gpu_feature() ||
        ...
        s = fuse_gpu_thread_loops(s, t, env);
